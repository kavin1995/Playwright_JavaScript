...
import {Policy_Change_PA} from '../../POM/PolicyCenter/Policy_Change_PA';

test('Change Policy',async({page})=>{

const login = new PC_Login(page);
const acc=new Account_Creation_PC(page);
const newSubPA =new New_Submission_PA(page);
const changePol = new Policy_Change_PA(page);
